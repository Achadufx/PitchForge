// Shared Gemini transport. Serves INVESTOR RESEARCH and DOCUMENT ANALYSIS:
//   lib/researchInvestor.js
//   pages/api/analyze-documents.js
//   pages/api/extract-text.js
//
// PITCH WRITING runs on lib/groqClient.js instead. The split is deliberate:
// Gemini has the more recent training cutoff and better recall of specific VCs
// and recent deals (notably outside the US), which is what research needs; Groq
// has the generous free tier, which is what per-investor pitch writing needs.
//
