...
export async function researchInvestor(investorName, firm) {
  ...
  try {
    ...
    result = await callGemini({
      ...
      timeoutMs: 18000,
      // Caps request + rate-limit backoff. research-and-pitch runs this and
      // generatePitch in one invocation, so the two must fit the 60s Vercel
      // function limit together.
      deadlineMs: 20000,
      jsonMode: true,
